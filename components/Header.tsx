    ...
    return <header className="text-center">
        ...
        <span className="absolute right-7 top-7"
            ...
            {theme === "dark" ?
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 fill-gray-400" viewBox="0 0 20 20" fill="currentColor">
        ...
        <Link href="/">
            <a className="cursor-pointer">
                <h1 className="text-5xl font-bold m-8 text-gray-400 dark:text-gray-500">Neuromancy</h1>
            </a>
        </Link>
    </header>
}